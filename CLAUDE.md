...
uv run pytest                    # Run all tests (1,600+)
...
Modular MCP server (64 modules) with ast-grep structural code search, Schema.org tools, refactoring, deduplication, quality, and documentation generation.
...
├── features/       # search, rewrite, refactoring, schema, deduplication, complexity, quality, documentation
...
- [PATTERNS.md](PATTERNS.md) - Refactoring patterns
...
- [docs/DOPPLER-MIGRATION.md](docs/DOPPLER-MIGRATION.md) - Secrets
