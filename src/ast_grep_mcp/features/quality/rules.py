...
def save_rule_to_project(rule: LintingRule, project_folder: str) -> str:
    ...
    try:
        ...
        logger.info("rule_saved", rule_id=rule.id, file_path=str(rule_file), language=rule.language)
