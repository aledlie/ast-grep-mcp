...
- [2026-03-09: Complexity Offender Reductions](changelog/2026-03-09-complexity-offender-reductions.md) — 4 complexity items refactored via helper extraction, nest/cyc reduced on 4 functions; 4 SC-* script hardening items (CWD fix, decorator robustness, language field, type annotation)
