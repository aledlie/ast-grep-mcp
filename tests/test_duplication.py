...
class TestGroupDuplicates:
    ...
    def test_groups_identical_matches(self):
...
class TestGenerateRefactoringSuggestions:
    ...
    def test_function_definition_suggestions(self):
    ...
    def test_class_definition_suggestions(self):
    ...
    def test_calculates_line_savings(self):
...
class TestFindDuplicationTool:
    ...
    def test_finds_duplicate_functions(self, mock_stream):
    ...
    @patch("main.stream_ast_grep_results")
    def test_no_duplicates_found(self, mock_stream):
    ...
    @patch("main.stream_ast_grep_results")
    def test_no_constructs_found(self, mock_stream):
