...
class TestAlignCodeBlocksIdentical:
    ...
    def test_identical_single_line(self):
        ...
        code = "x = 1"
        result = align_code_blocks(code, code)
    ...
    def test_identical_empty_blocks(self):
    ...
    def test_identical_with_different_whitespace(self):
        """Code differing only in leading/trailing whitespace should align with ignore_whitespace=True."""
        code1 = "  x = 1  "
        code2 = "x = 1"
        result = align_code_blocks(code1, code2, ignore_whitespace=True)
    ...
    def test_whitespace_difference_detected(self):
        ...
        code1 = "x=1"
        code2 = "x = 1"
        result = align_code_blocks(code1, code2, ignore_whitespace=False)
...
class TestAlignCodeBlocksSingleLineDiff:
    ...
    def test_single_value_change(self):
        ...
        code1 = "def foo():\n    x = 1\n    return x"
        code2 = "def foo():\n    x = 2\n    return x"
        result = align_code_blocks(code1, code2)
    ...
    def test_comment_only_line_difference(self):
        """Comments should be ignored when ignore_comments=True."""
        code1 = "x = 1\n# comment 1\ny = 2"
        code2 = "x = 1\n# comment 2\ny = 2"
        result = align_code_blocks(code1, code2, ignore_comments=True)

        # Both comments normalize to empty, so they should match
        assert result.aligned_lines == 3
        assert result.divergent_lines == 0

    def test_comment_difference_detected(self):
        """Comment differences detected when ignore_comments=False."""
        code1 = "# comment 1"
        code2 = "# comment 2"
        result = align_code_blocks(code1, code2, ignore_comments=False)
...
class TestBuildDiffTree:
    ...
    def test_build_tree_from_simple_result(self):
        """Build tree from simple alignment result."""
        result = align_code_blocks("x = 1", "x = 1")
...
class TestDiffTreeTraversal:
    ...
    def test_find_divergent_regions(self):
    ...
    def test_find_aligned_regions(self):
...
class TestFormatAlignmentDiff:
    ...
    def test_format_simple_aligned(self):
    ...
    def test_format_with_divergent(self):
    ...
    def test_format_with_deletions(self):
    ...
    def test_format_with_insertions(self):
        """Format output with inserted lines."""
        result = align_code_blocks("a", "a\nb")
        output = format_alignment_diff(result)
    ...
    def test_format_multiline_summary(self):
...
class TestBuildNestedDiffTree:
    ...
    def test_nested_tree_preserves_similarity(self):
...
class TestEdgeCases:
    ...
    def test_very_long_lines(self):
        ...
        long_line = "x = " + "a" * 1000
        result = align_code_blocks(long_line, long_line)
    ...
    def test_segment_line_positions(self):
